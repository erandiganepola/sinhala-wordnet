...
import static org.sinhala.wordnet.css.common.Constants.Properties.FROM_EMAIL;
...
public class UserController {
    ...
    public String SignUp(@ModelAttribute User user, ModelMap model) {
        ...
        String from = System.getProperty(FROM_EMAIL);
        String to = user.getEmail();
        String subject = "Wordnet.lk account verification";
        String content = "<p>Thank you for registering on wordnet.lk. Please click the link below to confirm your " +
                "account.</p><br><p><a href=\"http://www.wordnet.lk/Verify?key=" + key + "\" >" +
                "http://www.wordnet.lk/crowdsource/Verify?key=" + key + "</a></p>";
