...
<script type="text/javascript" src="theme/js/textboxtrans.js"></script>
										...
										<tbody>
											...
											<tr>
												...
												<td><form:input class="lemmaval"
														...
														type="text/html; charset=UTF-8" maxlength="255" size="22"  onkeypress="transliterate(this);" onkeyup="transliterate(this);"/></td>
											</tr>

											<tr>
												<td><label>ප්‍රකෘතිය</label></td>
												<td><form:input path="words[${loop.index}].root.lemma"
														type="text" maxlength="255" size="22" class="root"  onkeyup="transliterate(this);"/>
											...
											<tr>
												...
												<td><form:input
														...
														maxlength="255" size="22"  onkeyup="transliterate(this);"/></td>
											</tr>
										</tbody>
									</table>
								</div>
						...
						<table class="word_table">
							<tbody>
								...
								<tr>
									...
									<td><form:textarea path="definition" rows="5" cols="30"  onkeyup="transliterate(this);"/></td>
								</tr>
								<tr>
									<td><label>සිංහල උදාහරණ :</label></td>
									<td><form:textarea path="example" rows="5" cols="30"  onkeyup="transliterate(this);"/></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><form:textarea path="comment" rows="5" cols="30"  onkeyup="transliterate(this);"/></td>
								</tr>
								<tr>
