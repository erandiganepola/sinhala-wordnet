...
public class AdjectiveSynset extends SinhalaWordNetSynset {
    ...
    public AdjectiveSynset(String id, long offset, String definition, String example, SinhalaWordNetWord gender,
                                  List<SinhalaWordNetWord> words, List<SinhalaWordNetSynset> similar,
                                  List<SinhalaWordNetSynset> attributes, List<SinhalaWordNetSynset> alsoSee) {
    ...
    public AdjectiveSynset(String id, long offset, String definition, String example, List<SinhalaWordNetWord> words,
