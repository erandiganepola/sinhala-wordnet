...
public class VerbSynset extends SinhalaWordNetSynset {
    ...
    public VerbSynset(String id, long offset, String definition, String example, SinhalaWordNetWord gender,
                             List<SinhalaWordNetWord> words, List<SinhalaWordNetSynset> hypernyms,
                             List<SinhalaWordNetSynset> troponyms, List<SinhalaWordNetSynset> entailments,
                             List<SinhalaWordNetSynset> cause) {
    ...
    public VerbSynset(String id, long offset, String definition, String example, List<SinhalaWordNetWord> words,
