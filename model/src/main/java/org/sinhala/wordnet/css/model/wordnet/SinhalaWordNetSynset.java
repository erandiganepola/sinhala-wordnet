...
public class SinhalaWordNetSynset {
    ...
    public SinhalaWordNetSynset(String id, long offset, String definition, String example, SinhalaWordNetWord gender,
    ...
    public SinhalaWordNetSynset(String id, long offset, String definition, String example,
                                       List<SinhalaWordNetWord> words, SinhalaWordNetWord gender) {
        super();
        this.id = id;
        this.offset = offset;
        this.definition = definition;
