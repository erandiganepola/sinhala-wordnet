...
public class SinhalaSynsetMongoSynsetConvertor {
    ...
    public MongoSinhalaSynset converttoMongoSynset(SinhalaWordNetSynset Synset) {
        ...
        for (int i = 0; i < words.size(); i++) {
            ...
            if (sinhalaWordNetword != null) { // antonym handle part
                ...
                MongoSinhalaWordPointer wordPointer1 =
                        new MongoSinhalaWordPointer("n", con, sinhalaWordNetword.getLemma(),
            ...
            try {
                ...
                if (sinhalaWordNetword != null) { // derivationtype handle part
                    ...
                    MongoSinhalaWordPointer wordPointer2 =
                            new MongoSinhalaWordPointer("d", tempSynId, "0", MongoSinhalaPointerTyps.DERIVATION_TYPE);
            ...
            try {
                ...
                if (sinhalaWordNetword.getId() != null) { // origin handler part
                    ...
                    MongoSinhalaWordPointer wordPointer3 =
                            new MongoSinhalaWordPointer("o", tempSynId, "0", MongoSinhalaPointerTyps.ORIGIN);
            ...
            try {
                ...
                if (sinhalaWordNetword.getId() != null && !sinhalaWordNetword.getLemma()
                                                                   .equals("")) { // root handler part
                    //System.out.println("test"+sinhalaWordNetword.getLemma()+"123");
                    dbHandler.addRoot(sinhalaWordNetword.getLemma(), userName);
                    MongoSinhalaWordPointer wordPointer4 = new MongoSinhalaWordPointer("r", dbHandler.findRootByLemma(
                            sinhalaWordNetword.getLemma()).getId(), "0", MongoSinhalaPointerTyps.ROOT);
            ...
            try {
                ...
                if (sinhalaWordNetword.getId() != null) {
                    ...
                    MongoSinhalaWordPointer wordPointer5 =
                            new MongoSinhalaWordPointer("u", tempSynId, "0", MongoSinhalaPointerTyps.USAGE);
        ...
        try {
            ...
            for (int i = 0; i < holoSynsets.size(); i++) {
                ...
                MongoSinhalaSencePointer sencePointer =
                        new MongoSinhalaSencePointer("n", holoSynsetID, MongoSinhalaPointerTyps.PART_HOLONYM);
        ...
        try {
            ...
            for (int i = 0; i < hypernymSynsets.size(); i++) {
                ...
                MongoSinhalaSencePointer sencePointer =
                        new MongoSinhalaSencePointer("n", hypernymSynsetID, MongoSinhalaPointerTyps.HYPERNYM);
                sencePointerList.add(sencePointer);
            }
        } catch (Exception e) {
            System.out.println(e);
        ...
        try {
            ...
            for (int i = 0; i < hyponymSynsets.size(); i++) {
                ...
                MongoSinhalaSencePointer sencePointer =
                        new MongoSinhalaSencePointer("n", hyponymSynsetID, MongoSinhalaPointerTyps.HYPONYM);
                sencePointerList.add(sencePointer);
        ...
        try {
            ...
            for (int i = 0; i < attributeSynsets.size(); i++) {
                ...
                MongoSinhalaSencePointer sencePointer =
                        new MongoSinhalaSencePointer("n", attributeSynsetID, MongoSinhalaPointerTyps.ATTRIBUTE);
                sencePointerList.add(sencePointer);
            }
        } catch (Exception e) {
            System.out.println(e);
        ...
        try {
            ...
            for (int i = 0; i < meronymSynsets.size(); i++) {
                ...
                MongoSinhalaSencePointer sencePointer =
                        new MongoSinhalaSencePointer("n", meronymSynsetID, MongoSinhalaPointerTyps.PART_MERONYM);
                sencePointerList.add(sencePointer);
            }
        ...
        try {
            ...
            if (gender != null) {
                ...
                MongoSinhalaSencePointer sencePointer =
                        new MongoSinhalaSencePointer("g", tempSynId, MongoSinhalaPointerTyps.GENDER);
                sencePointerList.add(sencePointer);
            }
        ...
        if (Synset instanceof NounSynset) { // if noun synset
            ...
            mongoSynset = new MongoSinhalaNoun(ewnid, wordList, sencePointerList,
                                                      Synset.getDefinition() + "|" + Synset.getExample(), userName);
            ...
            mongoSynset = new MongoSinhalaVerb(ewnid, wordList, sencePointerList,
                                                      Synset.getDefinition() + "|" + Synset.getExample(), userName);
            mongoSynset.setComment(comment);
            mongoSynset.setRating(rating);
            if (evaluated.equals("true")) {
            ...
            MongoSinhalaAdjective tempsyn =
                    (MongoSinhalaAdjective) dbHandler.findBySynsetId(Synset.getOffset(), POS.ADJECTIVE);
            if (tempsyn != null) {
                List<MongoSinhalaSencePointer> tempSencePointer = new ArrayList<MongoSinhalaSencePointer>();
                tempSencePointer = tempsyn.getSencePointers();
                for (int i = 0; i < tempSencePointer.size(); i++) {
            ...
            mongoSynset = new MongoSinhalaAdjective(ewnid, wordList, sencePointerList,
                                                           Synset.getDefinition() + "|" + Synset.getExample(),
                                                           userName);
            mongoSynset.setComment(comment);
            mongoSynset.setRating(rating);
            if (evaluated.equals("true")) {
            ...
            mongoSynset = new MongoSinhalaAdverb(ewnid, wordList, sencePointerList,
                                                        Synset.getDefinition() + "|" + Synset.getExample(), userName);
            mongoSynset.setComment(comment);
            mongoSynset.setRating(rating);
            if (evaluated.equals("true")) {
    ...
    public SinhalaWordNetSynset OverWriteByMongo(SinhalaWordNetSynset synset, String mongoId) {
        ...
        if (mongoId != null && mongoId != "") {
            ...
            mongoSynset = mongoDBhandler.findBySynsetId(synset.getOffset(), pos);
        ...
        if (mongoSynset != null) {
            ...
            for (int i = 0; i < mongoWords.size(); i++) {
                ...
                for (int j = 0; j < wordPointers.size(); j++) {
                    ...
                    } else if (wordPointers.get(j).getPointerType().equals(MongoSinhalaPointerTyps.ROOT)) {
                        SinhalaWordNetWord pointerWordRoot = new SinhalaWordNetWord();

                        SynsetMongoDbHandler dbHandler = new SynsetMongoDbHandler();
                        MongoSinhalaRoot root =
                                dbHandler.findRootByID(String.valueOf(wordPointers.get(j).getSynsetIDasString()));
                        if (root != null) {
                            pointerWordRoot.setLemmaFromMongo(root.getWords().get(0).getLemma());
                            pointerWordRoot.setId(root.getWords().get(0).getId());
            ...
            if (pos.equals(POS.NOUN)) {
                ...
                if (parts.length > 1) {
                    ...
                    tempNoun =
                            new NounSynset(mongoSynset.getId(), synset.getOffset(), parts[0], parts[1], updatedUiWords,
                                                  genderWord);
                } else if (parts.length > 0) {
                    tempNoun = new NounSynset(mongoSynset.getId(), synset.getOffset(), parts[0], "", updatedUiWords,
                                                     genderWord);
                } else {
                    tempNoun =
                            new NounSynset(mongoSynset.getId(), synset.getOffset(), "", "", updatedUiWords, genderWord);
                }
                ...
                if (parts.length > 1) {
                    ...
                    tempVerb =
                            new VerbSynset(mongoSynset.getId(), synset.getOffset(), parts[0], parts[1], updatedUiWords,
                                                  genderWord);
                } else if (parts.length > 0) {
                    tempVerb = new VerbSynset(mongoSynset.getId(), synset.getOffset(), parts[0], "", updatedUiWords,
                                                     genderWord);
                } else {
                    tempVerb =
                            new VerbSynset(mongoSynset.getId(), synset.getOffset(), "", "", updatedUiWords, genderWord);
                }
                ...
                if (parts.length > 1) {
                    ...
                    tempAdj = new AdjectiveSynset(mongoSynset.getId(), synset.getOffset(), parts[0], parts[1],
                                                         updatedUiWords, genderWord);
                } else if (parts.length > 0) {
                    tempAdj = new AdjectiveSynset(mongoSynset.getId(), synset.getOffset(), parts[0], "", updatedUiWords,
                                                         genderWord);
                } else {
                    tempAdj = new AdjectiveSynset(mongoSynset.getId(), synset.getOffset(), "", "", updatedUiWords,
                                                         genderWord);
                }
                ...
                if (parts.length > 1) {
                    ...
                    tempAdj = new AdverbSynset(mongoSynset.getId(), synset.getOffset(), parts[0], parts[1], genderWord,
                                                      updatedUiWords);
                } else if (parts.length > 0) {
                    tempAdj = new AdverbSynset(mongoSynset.getId(), synset.getOffset(), parts[0], "", genderWord,
                                                      updatedUiWords);
                } else {
                    tempAdj = new AdverbSynset(mongoSynset.getId(), synset.getOffset(), "", "", genderWord,
                                                      updatedUiWords);
                }
                tempAdj.setCommentByMongo(mongoSynset.getComment());
                tempAdj.setRating(mongoSynset.getRating());
