...
//                                            }
    ...
    private static void printOverview(POS pos, IndexWord iw, boolean needGloss, boolean needLex, boolean needOffset, boolean needSenseNum, boolean needSenseKeys) throws JWNLException {
